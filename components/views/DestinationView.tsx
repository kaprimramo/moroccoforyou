      ...
      <section className="mx-auto max-w-4xl px-4 py-10">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl overflow-hidden border border-brand-night/10">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3323.8!2d-7.5898!3d33.3675!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3Ade0b2e55dcfd4df1!2sMoroccoForYou!5e0!3m2!1sen!2sma!4v1"
              width="100%"
              height="300"
              style={{ border: 0 }}
              allowFullScreen
